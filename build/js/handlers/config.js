...
backend.routes.push({
    name: "QCObjects Admin Panel Handlers!",
    description: "This endpoint returns a list of handlers available in the application",
    path: "^/admin/api/handlers$",
    microservice: "qcobjects-admin/handlers",
    headers: {
