...
Getting command response...`].map((s,r)=>{setTimeout(()=>{(0,n.typewriter)(this.term,s+`\r
$ `),this.term.write(`\r
...
`).map((c,l)=>{setTimeout(()=>{(0,n.typewriter)(this.term,c+`
`)},800*(l+1))})}).catch(s=>t.logger.warn(s.message))}},"InstallPluginsController")])});export{u as a};
//# sourceMappingURL=chunk-5LX4P7RF.js.map
