...
$ `)},1500*(r+1))});let e=new s.Service;e.url="https://192.168.100.10:8443/admin/api/plugins/i",e.method="POST",e.done=()=>s.logger.debug(`Plugin ${this.component.data.package} was installed.`),e.data={package:"qcobjects-lib-mailchimp-api"},(0,s.serviceLoader)(e,!1).then(({service:t})=>{JSON.parse(t.template).message.split(`
...
//# sourceMappingURL=chunk-JOD55NDP.js.map
