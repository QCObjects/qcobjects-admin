...
`).map((l,p)=>{setTimeout(()=>{(0,n.typewriter)(this.term,`${l}`),this.term.write(`\r
 `)},800*(p+1))}),i.NotificationComponent.success(`${this.component.data.package} was installed!`)}).catch(t=>{i.NotificationComponent.danger(`It was not possible to install ${this.component.data.package}.`),s.logger.warn(t.message)})}},"InstallPluginsController")])});export{h as a};
//# sourceMappingURL=chunk-SPIRVEF3.js.map
