...
import { NPMQCObjectsHandlersService } from "./services/com.qcobjects.admin.services.npm";
...
class PluginsHandler extends BackendMicroservice {
    ...
    const installed = CONFIG.get("backend", {handlers:[]}).handlers as Array<string>;
    const npmAvailable = new NPMQCObjectsHandlersService();
