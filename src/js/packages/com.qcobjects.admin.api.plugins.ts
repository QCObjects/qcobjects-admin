...
import { NPMQCObjectsPluginsService } from "./services/com.qcobjects.admin.services.npm";
...
class PluginsHandler extends BackendMicroservice {
    ...
    const installed = CONFIG.get("backend", {plugins:[]}).plugins as Array<string>;
    const npmAvailable = new NPMQCObjectsPluginsService();
